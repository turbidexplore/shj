package com.turbid.explore.tools.p;
...
public class WechatSpider extends BreadthCrawler {

    public static final Logger LOG = LoggerFactory.getLogger(WechatSpider.class);

    protected String historyKeysPath;

    protected BufferedWriter historyKeysWriter;

    public WechatSpider(String crawlPath, String historyKeysPath) throws Exception {
